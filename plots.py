...
def main(argv):
    ...
    # runtime_df.plot()
    runtime_df.plot(kind='line', x='Run', y=['Memory time', 'Disk time', 'Calc time', 'App time src', 'App time observed all cpus', 'Tot time observed all cpus', 'App time observed CPU 0', 'App time observed CPU 1', 'Tot time observed CPU 0', 'Tot time observed CPU 1', 'Idle time CPU 0', 'Idle time CPU 1', 'Idle % CPU 0', 'Idle % CPU 1'], xticks=runtime_df['Run'])
